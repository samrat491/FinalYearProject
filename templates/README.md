...
Below is the complete Flask backend code that powers the application, including routing, session management, secure file uploads, and Oracle Database queries.
